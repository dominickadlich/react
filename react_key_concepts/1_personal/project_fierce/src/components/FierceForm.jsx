...
function FierceForm() {
  ...
  async function storeMemory(prevState, formData) {
    ...
    setMemories((prevMemories) => [...prevMemories, savedMemory]);
  }
  ...
  return (
    <>
      <form action={formAction}>
        <div className="space-y-12">
          <div className="border-b border-gray-900/10 pb-12">
            <h1 className="text-base/7 font-semibold text-violet-900">
              Leave a Memory
            </h1>
              ...
              <div className="sm:col-span-4">
                ...
                <div className="mt-2">
                  <div className="flex items-center rounded-md bg-white pl-3 outline-1 -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600">
                    <div className="shrink-0 text-base text-violet-500 select-none sm:text-sm/6">
                      Title
                    </div>
                    <input
                      type="text"
      ...
      <div>
        <h2>Your Memories</h2>
        {optimisticMemory.length === 0 && <p>Remember a time when...</p>}
